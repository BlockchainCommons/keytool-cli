% keytool-cli(SECTION) | User Commands
%
% "January 29 2023"
...
keytool-cli - program to do something

# SYNOPSIS

**keytool-cli** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**keytool-cli** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **keytool-cli** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**keytool-cli** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    keytool-cli. See **foo.conf**(5) for further details.
...
**keytool-cli** provides some return codes, that can be used in scripts:
