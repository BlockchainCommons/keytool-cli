...
struct argp_option options[] = {
    ...
    {"purpose",                 -6, "INT", 0, "The purpose field of the BIP-44 derivation path."},
    {"coin-type",               -7, "INT", 0, "The coin type field of the BIP-44 derivation path."},
    {"account-index",           -8, "INT", 0, "The account field of the BIP-44 derivation path."},
    ...
    {"chain-type-int",          -13, "INT", 0, "The BIP-44 change field integer value."},
    {"address-index",           -14, "INT", 0, "The BIP-44 address_index field."},
    {"address-derivation-path", -15, "BIP32_PATH", 0, "The BIP-32 address derivation path."},
    {"address-key",             -16, "XPRV", 0, "The BIP-32 address HD key."},
    {"address-pub-key",         -17, "XPUB", 0, "The BIP-32 address public HD key."},
    {"address-ec-key",          -18, "ECPRV", 0, "The address EC key."},
    {"address-ec-key-wif",      -19, "WIF", 0, "The address EC key in WIF format."},
    {"address-pub-ec-key",      -20, "ECPUB", 0, "The compressed public EC key."},
    {"address-pkh",             -21, "ADDRESS", 0, "The pay-to-public-key-hash address."},
    {"address-sh",              -22, "ADDRESS", 0, "The pay-to-script-hash address."},
    {"output-descriptor-type",  -23, "ENUM pkh|wpkh|sh-wpkh", 0, "The output descriptor type."},
