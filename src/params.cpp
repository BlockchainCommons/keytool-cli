...
struct argp_option options[] = {
    ...
    {"partial-address-derivation-path", -15, "BIP32_PATH", 0, "The BIP-32 address derivation path."},
    {"address-derivation-path",         -16, "BIP32_PATH", 0, "The BIP-32 address derivation path."},
